...
void addLogLevel(LEVELS level) { addLogLevel(level, true); }
...
std::string to_string() { return to_string(internal::g_log_levels); }

std::map<int, g3::LoggingLevel> getAll() { return internal::g_log_levels; }
