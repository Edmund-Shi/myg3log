...
//  but not CopyConstructible or CopyAssignable. To put them in a std container
//  they need to be wrapped and their internals "moved" when tried to be copied.

template <typename Moveable> struct MoveOnCopy {
