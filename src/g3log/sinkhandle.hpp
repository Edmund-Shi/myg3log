...
public:
  SinkHandle(std::shared_ptr<internal::Sink<T>> sink) : _sink(sink) {}
  ...
  auto call(AsyncCall func, Args &&... args) -> std::future<
    ...
    try {
      ...
      typedef
          typename std::result_of<decltype(func)(T, Args...)>::type PromiseType;
