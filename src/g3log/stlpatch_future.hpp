...
template <class... _ArgTypes> class packaged_task<void(_ArgTypes...)> {
...
public:
  ...
  explicit operator bool() const { return _my_func != false; }

  bool valid() const { return _my_func != false; }

  future<void> get_future() { return _my_promise.get_future(); }
